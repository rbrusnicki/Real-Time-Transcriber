...
def create_microphone_icon():
    """Create a microphone icon and save it as both .ico and .png files"""
    ...
    # Save as png file for Linux
    img.save('microphone.png')
    
    return os.path.abspath('microphone.ico'), os.path.abspath('microphone.png')

if __name__ == "__main__":
    ico_path, png_path = create_microphone_icon()
